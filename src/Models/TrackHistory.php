 ...
 * @property string $changed_h_model_type
 * @property integer $changed_h_model_id
...
class TrackHistory extends Model
{
    ...
    protected $fillable = [
        'table_name', 'changed_model_type', 'changed_model_id', 'changed_h_model_type', 'changed_h_model_id',
     ...
     * @return MorphTo
     */
    public function changedHModel(): MorphTo
    {
        return $this->morphTo();
    }
