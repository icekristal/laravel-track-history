    ...
    public function handle(): void
    {
        ...
        $this->dirtyAttribute->filter(function ($value, $key) use ($columnsExceptions) {
            ...
            TrackHistory::query()->create([
                ...
                'changed_relationship_model_type' => !is_null($this->changedRelationshipModel) ? get_class($this->changedRelationshipModel) : null,
                'changed_relationship_model_id' => !is_null($this->changedRelationshipModel) ? $this->changedRelationshipModel->id : null,
